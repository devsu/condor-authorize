...
describe('Authorizer', () => {
  ...
  beforeEach((done) => {
    ...
    rulesHelper.createRulesFile().then(done).catch(done.fail);
  });

  afterEach((done) => {
    rulesHelper.removeRulesFile().then(done).catch(done);
  });
  ...
  describe('constructor()', () => {
    ...
    describe('without options', () => {
      ...
      describe('when access-rules.js file is not present', () => {
        beforeEach((done) => {
          rulesHelper.removeRulesFile().then(done).catch(done.fail);
        });
